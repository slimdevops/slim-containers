...
# Introduction
Ok, so let's be honest about this little Python-Flask photo app that we've built. As [@FrenchguyCH](https://twitch.tv/frenchguych) honestly assessed in [Twitch Stream 028](https://www.twitch.tv/videos/1255080620):
